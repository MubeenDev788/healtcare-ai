      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Empowering healthcare decisions with AI-powered consultations. 
              Get instant medical insights and recommendations from our advanced AI system.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 HealthAI. All rights reserved. Medical advice provided by AI for informational purposes only.
          </p>
